export const questions = [
  ...
  {
    questionText:
      "떨어진 내집 아래에 깔려 있는 마녀의 구두를 보고 드는 생각은?",
    answerOptions: [
      {
        answerText: "꺅!! 어떻게 사람이 깔렸어요! 도와주세요!",
        resultText: "협업할때는 맡은 역할을 잘 수행해내는 팀원의 역할이 잘 어울려!!",
        option: "front",
      },
      {
  ...
  {
    questionText:
      "북쪽 마녀가 집으로 돌아가기 위해서는 험난한 길을 지나 모두가 두려워 하는 8마법사를 만나야 한다고 한다 당신의 반응은?",
    answerOptions: [
      {
  ...
  {
    questionText:
      "마법사에게로 향하는 도중 누군가가 말을 걸어 돌아보니 움직이는 허수아비가 자신도 뇌를 갖고 싶다고 한다. 당신의 반응은?",
    answerOptions: [
      {
  ...
  {
    questionText:
      "허수아비와 함께 길을 걷다 녹슬어 버린 양철 나무꾼을 만나게 된다. 이야기를 나누어 보니 일년 간 꼼짝 못했다고 하는데 이때 당신의 반응은?",
    answerOptions: [
      {
  ...
  {
    questionText:
      "무시무시 해보이는 모습과는 달리 겁이 많은 사자를 만났다 이 때 사자에게 건내주고 싶은 말은?",
    answerOptions: [
      {
  ...
  {
    questionText:
      "마녀를 만났는데 늑대에게 우릴 공격하라고 명령하여 늑대가 우릴 에워싼 상태에서 나의 반응은?",
    answerOptions: [
      {
  ...
  {
    questionText:
      "끝없이 이어진 죽음의 양비귀 꽃밭에 들어간 당신, 어떤쪽에 속하는가? ",
    answerOptions: [
      {
        answerText:
  ...
  {
    questionText:
      "주문을 3번 외우면 날개 달린 원숭이를 부릴수 있는 모자가 생겼다. 당신은 무엇부터 할 것인가?",
    answerOptions: [
      {
  ...
  {
    questionText:
      "에메랄드시에 도착한 당신, 도시가 온통 초록색이다. 이때 먼저 든 생각은? ",
    answerOptions: [
      {
